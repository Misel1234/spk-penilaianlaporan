    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav2" class="nav-content collapse hide" data-bs-parent="#sidebar-nav">
          <li>
            <a href="data_kehadiran_tik.php" class="active">
              <i class="bi bi-circle"></i><span>Kehadiran</span>
            </a>
          </li>
          <li>
            <a href="data_alat_ht.php">
              <i class="bi bi-circle"></i><span>Monitoring Alat HT</span>
            </a>
          </li>
          <li>
            <a href="data_vicon.php">
              <i class="bi bi-circle"></i><span>Monitoring Vicon</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
        <a class="nav-link" href="data_kriteria.php">
          ...
          <span class="menu-title">DATA REKOMENDASI / KRITERIA</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="logintik.php">
