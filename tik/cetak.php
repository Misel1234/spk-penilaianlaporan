...
$pdf->SetLineWidth(0);
$pdf->ln(1);
$pdf->Cell(25,0.9,"SEKSI TEKNOLOGI INFORMASI DAN KOMUNIKASI",0,0,'C');
$pdf->ln(1);
...
$pdf->ln(1);
$pdf->Cell(25,0.7,"LAPORAN MONITORING ALAT HT",0,0,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
$pdf->Cell(1.5, 0.8, 'No', 1, 0, 'C');
$pdf->Cell(8, 0.8, 'Nama', 1, 0, 'C');
...
while($data = mysqli_fetch_array($query)){
  ...
  $pdf->Cell(1.5, 0.8, $no , 1, 0, 'C');
  $pdf->Cell(8, 0.8, $data['nama_alat_ht'],1, 0, 'C');
  $pdf->Cell(4, 0.8, $data['bidang'], 1, 0,'C');
  $pdf->Cell(4, 0.8, $data['c1'], 1, 0,'C');
  $pdf->Cell(4, 0.8, $data['status'], 1, 0,'C');
  $pdf->Cell(4, 0.8, $keterangan, 1, 0,'C');
  $pdf->ln();
  $no++;
}
...
$pdf->ln(1);
$pdf->Cell(25,0.7,"LAPORAN MONITORING VICON",0,0,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
$pdf->Cell(1.5, 0.8, 'No', 1, 0, 'C');
...
while($data = mysqli_fetch_array($query)){
  ...
  $pdf->Cell(1.5, 0.8, $no , 1, 0, 'C');
  $pdf->Cell(10, 0.8, $data['nama'],1, 0, 'C');
  $pdf->Cell(6, 0.8, $data['c1'], 1, 0,'C');
  $pdf->Cell(4, 0.8, $data['status'],1, 0, 'C');
