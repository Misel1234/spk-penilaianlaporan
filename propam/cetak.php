...
$pdf->SetLineWidth(0);
$pdf->ln(1);
$pdf->Cell(25,0.9,"SEKSI PROFESI DAN PENGAMANAN",0,0,'C');
$pdf->ln(1);
...
$pdf->ln(1);
$pdf->Cell(25,0.7,"LAPORAN KEHILANGAN",0,0,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
$pdf->Cell(1.5, 0.8, 'No', 1, 0, 'C');
...
$T       = mysqli_query($koneksi, "SELECT count(*) AS perbaikan FROM data_training_propam WHERE keterangan = 'Perbaikan'");
  ...
  $pdf->Cell(4, 0.8, $data1['bidang'],1, 0, 'C');
...
$pdf->ln(1);
$pdf->Cell(25,0.7,"LAPORAN KECELAKAAN",0,0,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
$pdf->Cell(1.5, 0.8, 'No', 1, 0, 'C');
$pdf->Cell(12, 0.8, 'Nama Anggota', 1, 0, 'C');
$pdf->Cell(6, 0.8, 'Penyelidikan', 1, 0, 'C');
$pdf->Cell(6, 0.8, 'Keterangan', 1, 0, 'C');
$pdf->Cell(6, 0.8, 'Hasil SPK', 1, 0, 'C');
$pdf->ln();
...
$no = 1;
  ...
  $pdf->Cell(1.5, 0.8, $no , 1, 0, 'C');
  $pdf->Cell(12, 0.8, $data1['nama_anggota'],1, 0, 'C');
  $pdf->Cell(6, 0.8, $data1['penyelidikan'], 1, 0,'C');
  $pdf->Cell(6, 0.8, $data1['keterangan'], 1, 0,'C');
  $pdf->Cell(6, 0.8, $keterangan, 1, 0,'C');
  $pdf->ln();
  $no++;
}
