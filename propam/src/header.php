...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <ul id="components-nav2" class="nav-content collapse hide" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="kehilangan.php">
              <i class="bi bi-circle"></i><span>Kehilangan Aset/Peralatan</span>
            </a>
          </li>
          <li>
            <a href="kecelakaan.php">
              <i class="bi bi-circle"></i><span>Laporan Kecelakaan</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
        <a class="nav-link" href="loginpropam.php">
